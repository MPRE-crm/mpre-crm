// buyer-intake-tts/lp-2-price.mjs
...
const TEXT =
  "Got it. And what's a comfortable price range or budget for your home search? This is just for guidance — not financial advice.";

const outPcmPath = path.join(
  __dirname,
  "../greetings/buyer-intake/lp-2-price.pcm"
);
