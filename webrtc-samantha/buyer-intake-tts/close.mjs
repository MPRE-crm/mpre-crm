...
const TEXT =
  "Perfect, we’ll get that scheduled. Is it okay if we text and email you updates along with a custom home search link? Once confirmed, I'll recap your price range, areas, timeline, and appointment details to make sure everything is correct.";

const outPcmPath = path.join(
  __dirname,
  "../greetings/buyer-intake/close.pcm"
);
