...
// 🔊 LPMAMA – LOCATION (post off-topic cutoff)
const TEXT =
  "Those were great questions — thanks. I’ll make sure the agent goes into more detail with you during the consultation. " +
  "To get your home search set up properly, which cities are you interested in — Boise, Meridian, Eagle, Star, Nampa, Caldwell, Kuna, Middleton, Emmett — or are you still exploring and not quite sure yet?";

const outPcmPath = path.join(
  __dirname,
  "../greetings/buyer-intake/lp-1-location.pcm"
);
