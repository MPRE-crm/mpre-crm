// buyer-intake-tts/contact2-email.mjs
...
const TEXT =
  "Thanks! And what’s the best email address for you? If you don’t mind, could you please spell it out for me, letter by letter?";

const outPcmPath = path.join(
  __dirname,
  "../greetings/buyer-intake/contact2-email.pcm"
);
