...
const TEXT = "How many units are you targeting, and do you have a general budget range in mind?";

const outPcmPath = path.join(__dirname, "../greetings/investor-intake/i06-units-budget.pcm");
