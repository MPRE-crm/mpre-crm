...
const TEXT = "Are you planning to purchase with cash, financing, a 1031 exchange, or a combination?";

const outPcmPath = path.join(__dirname, "../greetings/investor-intake/i07-capital-structure.pcm");
