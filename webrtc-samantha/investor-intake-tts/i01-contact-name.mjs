...
const TEXT = "Before we get started, may I have your first and last name?";

const outPcmPath = path.join(__dirname, "../greetings/investor-intake/i01-contact-name.pcm");
