...
const TEXT = "What type of properties are you looking for? For example, single family rentals, small multifamily, or something else?";

const outPcmPath = path.join(__dirname, "../greetings/investor-intake/i05-property-type.pcm");
