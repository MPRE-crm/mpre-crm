...
const TEXT = "What are your primary goals with this investment — cash flow, appreciation, tax strategy, or diversification?";

const outPcmPath = path.join(__dirname, "../greetings/investor-intake/i08-goals-returns.pcm");
