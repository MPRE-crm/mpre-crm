...
const TEXT = "Which Idaho area are you focused on — Boise, Coeur d'Alene, Idaho Falls, Twin Falls, or another area?";

const outPcmPath = path.join(__dirname, "../greetings/investor-intake/i04-market-focus.pcm");
