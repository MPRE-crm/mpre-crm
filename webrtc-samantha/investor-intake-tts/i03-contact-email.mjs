...
const TEXT = "Thanks! And what’s the best email address for you? If you don’t mind, could you please spell it out for me, letter by letter?";

const outPcmPath = path.join(__dirname, "../greetings/investor-intake/i03-contact-email.pcm");
