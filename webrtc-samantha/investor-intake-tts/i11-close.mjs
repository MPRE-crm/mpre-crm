...
const TEXT = "Perfect. I’ll pass this along and you’ll be connected with one of our investing specialists. Thanks for calling today.";

const outPcmPath = path.join(__dirname, "../greetings/investor-intake/i11-close.pcm");
