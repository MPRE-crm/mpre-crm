...
const TEXT = "What’s the best phone number to reach you on, and is it okay to call or text you there?";

const outPcmPath = path.join(__dirname, "../greetings/investor-intake/i02-contact-phone.pcm");
