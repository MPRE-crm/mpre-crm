...
const TEXT = "What does your timeline look like, and do you have prior investing experience?";

const outPcmPath = path.join(__dirname, "../greetings/investor-intake/i09-timeline-experience.pcm");
