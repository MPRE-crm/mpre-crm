...
const TEXT = "What’s the street address and city of the home you’re thinking about selling?";

const outPcmPath = path.join(__dirname, "../greetings/seller-intake/s04-property.pcm");
