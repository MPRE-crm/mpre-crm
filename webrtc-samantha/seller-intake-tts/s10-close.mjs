...
const TEXT = "Perfect. I’ll pass this along and you’ll be all set for the next step. Thanks for calling today.";

const outPcmPath = path.join(__dirname, "../greetings/seller-intake/s10-close.pcm");
