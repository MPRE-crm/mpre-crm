...
const TEXT = "The next step is a short consultation with one of our listing specialists. I show that we have two times avaliable. Would option A or option B work better for you?";

const outPcmPath = path.join(__dirname, "../greetings/seller-intake/s09-appointment.pcm");
