...
const TEXT = "What’s the best mobile number to reach you on, and is it okay to text you there?";

const outPcmPath = path.join(__dirname, "../greetings/seller-intake/s02-contact-phone.pcm");
