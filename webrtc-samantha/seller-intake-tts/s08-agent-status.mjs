...
const TEXT = "Becuase we legally have to ask. Are you currently listed with another agent or working with someone already?";

const outPcmPath = path.join(__dirname, "../greetings/seller-intake/s08-agent-status.pcm");
