...
const TEXT = "How many bedrooms and bathrooms does the home have, and about how many square feet?";

const outPcmPath = path.join(__dirname, "../greetings/seller-intake/s05-property.pcm");
